...
// 	FindAll(data interface{}) (interface{}, error)
// }
...
// func GetMysqlRepo() IMysqlService {
// 	return mysqlRepo
// }

// func SetMysqlRepo(mr IMysqlService) {
// 	mysqlRepo = mr
// }

// func (m *MysqlRepo) FindAll(data interface{}) (interface{}, error) {
